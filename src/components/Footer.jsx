...
const Footer = () => {
  return (
    <div className='bg-[#F6FF9F] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
      <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
        {/* Logo & Description */}
        <div className='max-w-80'>
          <img src={logo} alt="QuickStay logo" className='mb-4 h-8 md:h-9 invert opacity-80' />
        ...
        <div className='max-w-80'>
          ...
          <div className='flex items-center mt-4'>
            ...
            <button className='flex items-center justify-center bg-black h-9 w-9 rounded-r'>
              <img src={arrowIcon} alt="Submit icon" className='w-3.5 invert' />
            </button>
          </div>
        </div>
      </div>
